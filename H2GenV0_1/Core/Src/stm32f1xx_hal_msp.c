...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA5     ------> ADC1_IN5
    */
    GPIO_InitStruct.Pin = A_IN_4_20_Pin|A_IN_MAP_Pin|A_IN_WQ_Pin|A_IN_TEMP_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA5     ------> ADC1_IN5
    */
    HAL_GPIO_DeInit(GPIOA, A_IN_4_20_Pin|A_IN_MAP_Pin|A_IN_WQ_Pin|A_IN_TEMP_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PC8     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = D_OUT_1_Pin|D_OUT_2_Pin;
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART5_MspInit 0 */
    ...
    */
    ...
    /* UART5 DMA Init */
    /* UART5_RX Init */
    hdma_uart5_rx.Instance = DMA2_Channel4;
